...
?>
  ...
  <style>
    ...
    * {
    ...
    <?php if (isset($_GET['pic']) && !isset($_GET['bg'])) : ?>.plyr__poster {
  ...
  <body>
    ...
    <?php else : ?>
      <video id="player" playsinline controls data-poster="<?php if (isset($_GET['pic'])) {
                                                              echo $_GET['pic'];
                                                            } else {
                                                              echo 'https://ae02.alicdn.com/kf/Hae3544136d6f4bf9aafc7a5993e2ece6C.jpg';
